...
public class NotifyLayer2Message {
	...
	internal static NotifyLayer2Message GenRandom() => new() {
		ID = Tools.Maths.RNG.Next(0, 3), SubMessage1 = NotifyNewTransaction.GenRandom(),
		SubMessage2 = NotifyNewBlock.GenRandom()
	};
}
