//-----------------------------------------------------------------------
// <copyright file="DACTool.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen.Data {
	public static class DACTool {
		...
		public static bool TryFindPrimaryKeyColumnValue(AutoIdentityDAC.PrimaryKeyConvention convention, string tableName, IEnumerable<ColumnValue> clause, out ColumnValue primaryKeyColumnValue ) {
			...
			if (!convention.HasAnyFlags(AutoIdentityDAC.PrimaryKeyConvention.ID, AutoIdentityDAC.PrimaryKeyConvention.Id, AutoIdentityDAC.PrimaryKeyConvention.TableNameID, AutoIdentityDAC.PrimaryKeyConvention.TableNameId, AutoIdentityDAC.PrimaryKeyConvention.UseDatabaseStructure))
