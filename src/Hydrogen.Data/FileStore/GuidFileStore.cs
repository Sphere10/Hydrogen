...
namespace Hydrogen.Data {
	...
	public class GuidFileStore : FileStoreBase<Guid> {
		...
		public override IEnumerable<Guid> FileKeys => throw new NotImplementedException();

		public FileStorePersistencePolicy PersistencePolicy { get; init; } = FileStorePersistencePolicy.Perist;

		protected string BaseDirectory { get; set; }

		protected string FileExt { get; init; } = string.Empty;
		...
		public override string GetFilePath(Guid fileKey) {
            ...
            return Path.Combine(BaseDirectory, sanitizedGuid.Substring(0, 2), sanitizedGuid.Substring(2) + FileExt);
		}
        ...
        public override void RegisterMany(IEnumerable<Guid> fileKeys) {
