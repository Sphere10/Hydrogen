//-----------------------------------------------------------------------
// <copyright file="SQLBuilderDecorator.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Data {
	...
	public abstract class SQLBuilderDecorator : ISQLBuilder {
		...
		public ISQLBuilder LeafBuilder { 
			get {
				return _internalBuilder.LeafBuilder;
			}
			set {
				_internalBuilder.LeafBuilder = value;
			}
		}
		...
		public virtual ISQLBuilder Select(string tableName, IEnumerable<object> columns = null, bool distinct = false, int? limit = null, int? offset = null, IEnumerable<ColumnValue> columnMatches = null, string whereClause = null, string orderByClause = null, bool endStatement = false) {
		...
		public IEnumerable<SQLStatement> Statements { get { return _internalBuilder.Statements; } }
		...
		public virtual int StatementCount { get { return _internalBuilder.StatementCount; } set { _internalBuilder.StatementCount = value; } }

		public virtual int VariableDeclarationCount { get { return _internalBuilder.VariableDeclarationCount; } set { _internalBuilder.VariableDeclarationCount = value; } }
