//-----------------------------------------------------------------------
// <copyright file="GraphicsExtensions.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework {
	...
	public static class GraphicsExtensions {
		...
		public static void GradientFillAtAngle(this Graphics g, Rectangle rec, Color fromColor, Color toColor, int angle = 0, Blend blend = null) {
			if ((fromColor != Color.Empty || toColor != Color.Empty) && (rec.Width != 0 && rec.Height != 0)) {
