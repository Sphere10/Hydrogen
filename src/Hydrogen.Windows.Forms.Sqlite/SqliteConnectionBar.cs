//-----------------------------------------------------------------------
// <copyright file="SqliteConnectionBar.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Windows.Forms.Sqlite {
	public partial class SqliteConnectionBar : ConnectionBarBase, IDatabaseConnectionProvider {
		public SqliteConnectionBar() {
			InitializeComponent();
		...
		public bool HasPassword { get { return _passwordTextBox.Text.Trim().Length > 0; } }

		public string Password { get { return _passwordTextBox.Text;  } }

		public string Filename { get { return _fileSelectorControl.Path; } }

		public PathSelectionMode Mode { get { return _fileSelectorControl.Mode; } set { _fileSelectorControl.Mode = value; } }
