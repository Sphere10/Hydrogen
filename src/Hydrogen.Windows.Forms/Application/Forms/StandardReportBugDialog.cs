//-----------------------------------------------------------------------
// <copyright file="StandardReportBugDialog.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen.Windows.Forms {
    ...
    public partial class StandardReportBugDialog : ApplicationForm, IReportBugDialog {

        public StandardReportBugDialog() {
            InitializeComponent();
        }
        ...
        private void _sendButton_Click(object sender, EventArgs e) {
            ...
            try {
				...
				//    return;
				//}
				//webService.SubmitBugReport(
				//       new BugReport(
				//            _whoAreYouControl.UserType,
				//            email,
				//            WinFormsWinFormsApplicationServices.ProductInformation,
				//            _bugReportTextBox.Text
				//        )

				//);
			} catch (Exception error) {
                base.WinFormsApplicationServices.ReportError(error);
            } finally {
                if (close) {
                    Close();
                }
