//-----------------------------------------------------------------------
// <copyright file="ResizableAppointmentCellController.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen.Windows.Forms.AppointmentBook {
	...
	internal class ResizableAppointmentCellController : BaseCellController {
		...
		public new AppointmentBook Owner {
			get {
				return base.Owner as AppointmentBook;
			}
			set {
				base.Owner = value as AppointmentBook;
			}
		}
