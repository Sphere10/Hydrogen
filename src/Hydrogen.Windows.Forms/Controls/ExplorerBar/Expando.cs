//-----------------------------------------------------------------------
// <copyright file="Expando.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen.Windows.Forms {
	...
	public class Expando : Control, ISupportInitialize {
		...
		public bool Animating {
			get {
				return (this._animatingFade || this._animatingSlide);
			}
		}
		...
		public bool UseDefaultTabHandling {
			get {
				return this._useDefaultTabHandling;
			}

			set {
				this._useDefaultTabHandling = value;
			}
		}
		...
		public HeaderInfo CustomHeaderSettings {
			get {
				return this._customHeaderSettings;
			}
			internal set {
				this._customHeaderSettings = value;
			}
		}
