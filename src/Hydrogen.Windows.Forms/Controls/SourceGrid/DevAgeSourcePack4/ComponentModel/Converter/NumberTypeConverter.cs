//-----------------------------------------------------------------------
// <copyright file="NumberTypeConverter.cs" company="Sphere 10 Software">
//
...
//
		...
		public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
		{
			if (value != null && value.GetType() == typeof(string))
			{
				if (BaseType == typeof(double))
					...
					return StringToByte((string)value,NumberStyles,GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(sbyte))
                    return StringToSByte((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(byte))
                    return StringToShort((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(byte))
                    return StringToUShort((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(byte))
                    return StringToInt((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(byte))
                    return StringToUInt((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(byte))
                    return StringToLong((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(byte))
                    return StringToULong((string)value, NumberStyles, GetCulture(culture).NumberFormat);
                else
		...
		public override object ConvertTo(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
		{
			if (destinationType == typeof(string) && value != null)
			{
				if (BaseType == typeof(double))
                    ...
                    return ByteToString((byte)value, Format, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(sbyte))
                    return SByteToString((sbyte)value, Format, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(short))
                    return ShortToString((short)value, Format, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(ushort))
                    return UShortToString((ushort)value, Format, GetCulture(culture).NumberFormat);
                    ...
                    return UIntToString((uint)value, Format, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(long))
                    return LongToString((long)value, Format, GetCulture(culture).NumberFormat);
                else if (BaseType == typeof(ulong))
                    return ULongToString((ulong)value, Format, GetCulture(culture).NumberFormat);
                else
        ...
        public static byte StringToByte(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return byte.Parse(p_strVal, style, provider);
        }
        public static sbyte StringToSByte(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return sbyte.Parse(p_strVal, style, provider);
        }
        public static short StringToShort(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return short.Parse(p_strVal, style, provider);
        }
        public static ushort StringToUShort(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return ushort.Parse(p_strVal, style, provider);
        }
        public static int StringToInt(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return int.Parse(p_strVal, style, provider);
        }
        public static uint StringToUInt(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return uint.Parse(p_strVal, style, provider);
        }
        public static long StringToLong(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return long.Parse(p_strVal, style, provider);
        }
        public static ulong StringToULong(string p_strVal, System.Globalization.NumberStyles style, System.IFormatProvider provider) {
            return ulong.Parse(p_strVal, style, provider);
        }
		...
		public static string ByteToString(byte p_Val, System.String format , System.IFormatProvider provider  )
		{
			return p_Val.ToString(format,provider);
		}

        public static string SByteToString(sbyte p_Val, System.String format, System.IFormatProvider provider) {
            return p_Val.ToString(format, provider);
        }

        public static string ShortToString(short p_Val, System.String format, System.IFormatProvider provider) {
            return p_Val.ToString(format, provider);
        }

        public static string UShortToString(ushort p_Val, System.String format, System.IFormatProvider provider) {
            return p_Val.ToString(format, provider);
        }
        ...
        public static string UIntToString(uint p_Val, System.String format, System.IFormatProvider provider) {
            return p_Val.ToString(format, provider);
        }

        public static string LongToString(long p_Val, System.String format, System.IFormatProvider provider) {
            return p_Val.ToString(format, provider);
        }

        public static string ULongToString(ulong p_Val, System.String format, System.IFormatProvider provider) {
            return p_Val.ToString(format, provider);
        }
