//-----------------------------------------------------------------------
// <copyright file="Events.cs" company="Sphere 10 Software">
//
...
//	}
	...
	public class RangePaintEventArgs : EventArgs
	{
		...
		private CellRange mDrawingRange;
		public CellRange DrawingRange
		{
	...
	{
		private CellRange m_GridRange;
		public RangeEventArgs(CellRange p_GridRange)
		{
	...
	{
		public RangeCancelEventArgs(CellRange p_GridRange):base(p_GridRange)
		{
		}
	...
	{
		public SelectionChangeEventArgs(SelectionChangeEventType p_Type, CellRange p_Range)
		{
			m_Type = p_Type;
			m_Range = p_Range;
		}

		private CellRange m_Range;
	...
	public class SortRangeRowsEventArgs : EventArgs
	{
		...
		public SortRangeRowsEventArgs(CellRange p_Range,
		                              int keyColumn,
		                              bool p_bAscending,
	...
	public class RangeRegionChangedEventArgs : EventArgs
	{
		...
		public RangeRegionChangedEventArgs(CellRange addedRange, CellRange removedRange)
		{
