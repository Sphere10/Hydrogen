...
public struct RectangleBorder : IBorder {
	...
	public void Draw(GraphicsCache graphics, RectangleF rectangle) {
		...
		if (border.Left.Width > 0) {
			...
			graphics.Graphics.DrawLine(leftPen,
				new PointF(x, rectangle.Y),
				new PointF(x, bottom));
		}
		...
		if (border.Right.Width > 0) {
			...
			graphics.Graphics.DrawLine(rightPen,
				new PointF(x, rectangle.Y),
				new PointF(x, bottom));
		}
		...
		if (border.Top.Width > 0) {
			...
			graphics.Graphics.DrawLine(topPen,
				new PointF(rectangle.X, y),
				new PointF(right, y));
		}
		...
		if (border.Bottom.Width > 0) {
			...
			graphics.Graphics.DrawLine(bottomPen,
				new PointF(rectangle.X, y),
				new PointF(right, y));
		}
	}
