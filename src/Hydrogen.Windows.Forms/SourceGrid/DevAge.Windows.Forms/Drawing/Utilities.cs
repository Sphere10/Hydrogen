...
public static class Utilities {
	...
	public static void DrawGradient3DBorder(Graphics g,
		...
		//TopLeftBorder
		Color[] l_TopLeftGradient = Tools.Drawing.CalculateColorGradient(p_BackColor, l_TopLeft, l_TopLeftWidth);
		...
		//BottomRightBorder
		Color[] l_BottomRightGradient = Tools.Drawing.CalculateColorGradient(p_BackColor, l_BottomRight, l_BottomRightWidth);
