...
public class Header : HeaderBase {
	...
	public Header(float gradientAngle) {
		...
		Color darkdarkControl = Tools.Drawing.CalculateLightDarkColor(BackColor, -0.2f);
	...
	protected virtual void OnDrawBackground(GraphicsCache graphics, RectangleF area) {
		Color darkdarkControl = Tools.Drawing.CalculateLightDarkColor(BackColor, -0.2f);
		//Color darkControl = Tools.DrawingTool.CalculateLightDarkColor(BackColor, -0.1f);
		Color lightControl = Tools.Drawing.CalculateLightDarkColor(BackColor, 0.5f);
		Color hotLightControl = Tools.Drawing.CalculateMiddleColor(Color.FromKnownColor(KnownColor.Highlight), lightControl);
