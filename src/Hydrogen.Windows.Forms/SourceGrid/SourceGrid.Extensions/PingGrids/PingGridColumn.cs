...
public class PingGridColumn : ColumnInfo {
	...
	[Obsolete] private PropertyDescriptor mPropertyColumn = null;
	...
	[Obsolete] private List<Conditions.ICondition> mConditions = new List<Conditions.ICondition>();
	...
	[Obsolete] private Dictionary<Conditions.ICondition, ICellVirtual> mConditionalCells = new Dictionary<Conditions.ICondition, ICellVirtual>();
