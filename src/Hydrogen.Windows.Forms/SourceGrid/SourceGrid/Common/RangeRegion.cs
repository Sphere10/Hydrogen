//-----------------------------------------------------------------------
// <copyright file="RangeRegion.cs" company="Sphere 10 Software">
//
...
namespace SourceGrid
{
	...
	/// </summary>
	[Serializable]
	public class RangeRegion : ICollection<CellRange>
	{
		#region Constructors
		public RangeRegion()
		{
		...
		public RangeRegion(Position position)
		{
			if (position.IsEmpty() == false)
				m_RangeCollection.Add(new CellRange(position));
		}
		public RangeRegion(CellRange range)
		{
		...
		/// <returns></returns>
		public virtual bool Contains(CellRange p_Range)
		{
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public virtual bool IntersectsWith(CellRange p_Range)
		{
			if (p_Range.IsEmpty() || IsEmpty())
				return false;
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public virtual RangeRegion Intersect(CellRange p_Range)
		{
			...
			if (p_Range.IsEmpty() == false && IsEmpty() == false)
			{
				...
				for (int i = 0; i < m_RangeCollection.Count; i++)
				{
					CellRange intersectRange = p_Range.Intersect(m_RangeCollection[i]);
		...
		public RangeRegion Intersect(RangeRegion pRange)
		{
			...
			{
				CellRange rangeToCheck = pRange.m_RangeCollection[rToCheck];
		...
		/// <returns></returns>
		public RangeRegion Exclude(CellRange pRange)
		{
			RangeRegion range = new RangeRegion();
		...
		public void Clear(CellRange pRangeToLeave)
		{
		...
		{
			return Add(new CellRange(pCell));
		}
		...
		{
			return Remove(new CellRange(pCell));
		}
		...
		/// <param name="pRange"></param>
		/// <returns>Returns true if sucesfully added</returns>
		public bool Add(CellRange pRange)
		{
		...
		/// <param name="pRange"></param>
		/// <returns>Returns true if sucesfully removed</returns>
		public bool Remove(CellRange pRange)
		{
		...
		private bool InternalAdd(RangeRegion pRange)
		{
			...
			else
			{
				...
				{
					CellRange rangeToAdd = pRange.m_RangeCollection[rToAdd];
		...
		#region ICollection<CellRange> Members
		void ICollection<CellRange>.Add(CellRange item)
		{
			this.Add(item);
		}

		public void CopyTo(CellRange[] array, int arrayIndex)
		{
		...
		#region IEnumerable<CellRange> Members
