//-----------------------------------------------------------------------
// <copyright file="RangeMergerByRows.cs" company="Sphere 10 Software">
//
	...
	public class RangeMergerByRows
	{
		...
		private bool JoinAjdancedRecursive()
		{
			...
			for (int i = 0; i < m_ranges.Count - 1; i++)
			{
				...
				{
					CellRange newRange = new CellRange(first.Start.Row, m_columnStart,
		...
		{
			return new CellRange(rangeToNormalize.Start.Row, m_columnStart,
