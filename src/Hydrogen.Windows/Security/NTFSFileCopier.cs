//-----------------------------------------------------------------------
// <copyright file="NTFSFileCopier.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Windows.Security {
    ...
    public class NTFSFileCopier  {
        ...
        public bool CleanDestination {
            get {
                return _cleanDestination;
            }
            set {
                _cleanDestination = value;
            }
        }
        ...
        public bool CopyOwnership {
            get {
                return _copyOwnership;
            }
            set {
                _copyOwnership = value;
            }
        }

        public bool CopyTimestamps {
            get {
                return _copyTimestamps;
            }
            set {
                _copyTimestamps = value;
            }
        }
        ...
        public bool ResolveDanglingSIDs {
            get {
                return _resolveDanglingSIDs;
            }
            set {
                _resolveDanglingSIDs = value;
            }
        }

        public bool AutomaticallyImportLocalAccounts {
            get {
                return _automaticallyImportLocalAccounts;
            }
            set {
                _automaticallyImportLocalAccounts = value;
            }
        }
        ...
        public bool ForceOwnershipOnAccessDenied {
            get {
                return _forceOwnershipOnAccessDenied;
            }
            set {
                _forceOwnershipOnAccessDenied = value;
            }
        }

        public bool ContinueOnAllErrors {
            get {
                return _continueOnAllErrors;
            }
            set {
                _continueOnAllErrors = value;
            }
        }
                        ...
                        if (!isVeryLongPath) {
                            ...
                            foreach (NTShare share in RemoteHostShares) {
                                string sourceLocalPath =
                                    sourceDir.IsUNCPath() ?
                                        RemoteHost.ResolveUNCPathToLocalPath(sourceDir) :
                                        sourceDir;
