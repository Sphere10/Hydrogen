//-----------------------------------------------------------------------
// <copyright file="NTLocalUser.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen.Windows.Security {
    ...
    public class NTLocalUser : NTLocalObject {
        ...
        public TimeSpan PasswordAge {
            get {
                return TimeSpan.FromSeconds(_password_age);
            }
        }
        ...
        public DateTime AccountExpires {
            get {
                return 
                    (_acct_expires == unchecked((uint)-1))  ?
                    DateTime.MaxValue :
					Tools.Time.DateFrom1979Jan1(_acct_expires); 
            }
            set {
                _acct_expires =
                    (value == DateTime.MaxValue) ? 
                    unchecked((uint)-1) :
					value.MilliSecondsSince1979Jan1();
            }
        }
