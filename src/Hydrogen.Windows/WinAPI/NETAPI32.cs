//-----------------------------------------------------------------------
// <copyright file="NETAPI32.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Windows {
    public static partial class WinAPI {
        ...
        public static class NETAPI32 {
            ...
            [DllImport("netapi32.dll")]
            [return: MarshalAs(UnmanagedType.U4)]
            public static extern NET_API_STATUS NetLocalGroupGetMembers([MarshalAs(UnmanagedType.LPWStr)] string servername, [MarshalAs(UnmanagedType.LPWStr)] string localgroupname, uint level, out IntPtr bufptr, uint prefmaxlen, out uint entriesread, out uint totalentries, out int resume_handle);

            [DllImport("netapi32.dll")]
            [return: MarshalAs(UnmanagedType.U4)]
            public static extern NET_API_STATUS NetUserGetGroups([MarshalAs(UnmanagedType.LPWStr)] string servername, [MarshalAs(UnmanagedType.LPWStr)] string username, int level, out IntPtr bufptr, int prefmaxlen, out uint entriesread, out uint totalentries);
            ...
            [DllImport("netapi32.dll")]
            [return: MarshalAs(UnmanagedType.U4)]
            public static extern NET_API_STATUS NetUserGetLocalGroups([MarshalAs(UnmanagedType.LPWStr)] string servername, [MarshalAs(UnmanagedType.LPWStr)] string username, int level, int flags, out IntPtr bufptr, int prefmaxlen, out int entriesread, out int totalentries);
