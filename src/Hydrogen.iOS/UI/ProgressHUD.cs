//-----------------------------------------------------------------------
// <copyright file="ProgressHUD.cs" company="Sphere 10 Software">
//
...
//		private string _sizedToDetailText;
//
//
...
//
//		public MBProgressHUD(UIWindow window)
//			: base(window.Bounds) {
//			Initialize();
//		}
//
//		public MBProgressHUD(UIView view)
//			: base(view.Bounds) {
//			Initialize();
//		}
//
//		public MBProgressHUD(CGRect frame)
//			: base(frame) {
//			Initialize();
//		}
//
...
//			indFrame = new CGRect((float)Math.Floor((frame.Size.Width - indFrame.Size.Width) / 2) + this.XOffset, (float)Math.Floor((frame.Size.Height - indFrame.Size.Height) / 2) + this.YOffset, indFrame.Size.Width, indFrame.Size.Height);
//			Indicator.Frame = indFrame;
//
//			// Add label if label text was set 
//			if (null != this.TitleText) {
//				// Get size of label text
//				CGSize dims = StringSize(TitleText, this.TitleFont);
//
...
//				indFrame = new CGRect(indFrame.Location.X, indFrame.Location.Y - (float)(Math.Floor(lHeight / 2 + PADDING / 2)), indFrame.Width, indFrame.Height);
//				Indicator.Frame = indFrame;
//
//				// Set the label position and dimensions
//				CGRect lFrame = new CGRect((float)Math.Floor((frame.Size.Width - lWidth) / 2) + XOffset, (float)Math.Floor(indFrame.Location.Y + indFrame.Size.Height + PADDING), lWidth, lHeight);
//				Label.Frame = lFrame;
//
//				this.AddSubview(Label);
//
//				// Add details label delatils text was set
//				if (_sizedToDetailText != this.DetailText) {
//					_sizedToDetailText = this.DetailText;
//					// Get size of label text
...
//					lFrame = new CGRect(lFrame.Location.X, lFrame.Location.Y - ((float)Math.Floor(lHeight / 2 + PADDING / 2)), lFrame.Width, lFrame.Height);
//					Label.Frame = lFrame;
//
//					// Set label position and dimensions
//					CGRect lFrameD = new CGRect((float)Math.Floor((frame.Size.Width - lWidth) / 2) + XOffset, lFrame.Location.Y + lFrame.Size.Height + PADDING, lWidth, lHeight);
...
//			// Center HUD
//			CGRect allRect = this.Bounds;
//			// Draw rounded HUD bacgroud rect
//			CGRect boxRect = new CGRect(((allRect.Size.Width - this.Width) / 2) + this.XOffset, ((allRect.Size.Height - this.Height) / 2) + this.YOffset, this.Width, this.Height);
//			CGContext ctxt = UIGraphics.GetCurrentContext();
//			this.FillRoundedRect(boxRect, ctxt);
//		}
//
//		void FillRoundedRect(CGRect rect, CGContext context) {
//			float radius = 10.0f;
//			context.BeginPath();
//			context.SetGrayFillColor(0.3f, this.Opacity);
...
//		public MBRoundProgressView()
//			: base(new CGRect(0.0f, 0.0f, 37.0f, 37.0f)) {
//		}
//
//		public override void Draw(CGRect rect) {
//			CGRect allRect = this.Bounds;
//			CGRect circleRect = new CGRect (allRect.Location.X + 2, allRect.Location.Y + 2, allRect.Size.Width - 4, allRect.Size.Height - 4);
//
