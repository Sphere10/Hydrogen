...
//	public override void Serialize(ClusteredStorageTrack item, EndianBinaryWriter writer) {
//		writer.Write(item.StartCluster);
//		writer.Write(item.RecordCount);
//		return true;
//	}

//	public override ClusteredStorageTrack Deserialize(EndianBinaryReader reader) {
