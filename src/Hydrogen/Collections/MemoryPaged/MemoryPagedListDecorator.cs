...
public class MemoryPagedListDecorator<TItem, TMemoryPagedList> : PagedListDecorator<TItem, TMemoryPagedList>, IMemoryPagedList<TItem> where TMemoryPagedList : IMemoryPagedList<TItem> {
	public event EventHandlerEx<object, IMemoryPage<TItem>> PageLoading {
		add => InternalCollection.PageLoading += value;
		remove => InternalCollection.PageLoading -= value;
	}

	public event EventHandlerEx<object, IMemoryPage<TItem>> PageLoaded {
		add => InternalCollection.PageLoaded += value;
		remove => InternalCollection.PageLoaded -= value;
	}

	public event EventHandlerEx<object, IMemoryPage<TItem>> PageSaving {
		add => InternalCollection.PageSaving += value;
		remove => InternalCollection.PageSaving -= value;
	}

	public event EventHandlerEx<object, IMemoryPage<TItem>> PageSaved {
		add => InternalCollection.PageSaved += value;
		remove => InternalCollection.PageSaved -= value;
	}

	public event EventHandlerEx<object, IMemoryPage<TItem>> PageUnloading {
		add => InternalCollection.PageUnloading += value;
		remove => InternalCollection.PageUnloading -= value;
	}

	public event EventHandlerEx<object, IMemoryPage<TItem>> PageUnloaded {
		add => InternalCollection.PageUnloaded += value;
		remove => InternalCollection.PageUnloaded -= value;
	}
