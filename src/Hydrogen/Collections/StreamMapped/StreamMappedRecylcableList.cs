...
//public class StreamMappedRecylcableList<TItem> : SingularCollectionBase<TItem>, IStreamMappedRecylableList<TItem> {
...
//	public StreamMappedRecylcableList(
//		Stream rootStream,
//		int clusterSize,
...
//	internal StreamMappedRecylcableList(
//		ObjectContainer<TItem> objectContainer,
...
//	) {
//		Guard.ArgumentNotNull(objectContainer, nameof(objectContainer));
//		Guard.ArgumentNotNull(checksumIndex, nameof(checksumIndex));
//		_version = 0;
