//-----------------------------------------------------------------------
// <copyright file="DecayGauge.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen {
	...
	public sealed class DecayGauge {
		...
		public double DecayCoefficient { get { return _decayCoefficient; } set { _level = Level; _decayCoefficient = value; } }

		public double DecayExponent { get { return _decayExponent; } set { _level = Level; _decayExponent = value; } }

		public double DecayOffset { get { return _decayOffset; } set { _level = Level; _decayOffset = value; } }
