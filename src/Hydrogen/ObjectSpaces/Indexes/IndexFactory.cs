...
internal static class IndexFactory {
	...
	internal static IClusteredStreamsAttachment CreateKeyIndexAttachment(ObjectContainer container, long streamIndex, Member member, IItemSerializer keySerializer = null, object keyComparer = null) {
	...
	internal static IClusteredStreamsAttachment CreateUniqueKeyIndexAttachment(ObjectContainer container, long streamIndex, Member member, IItemSerializer keySerializer = null, object keyComparer = null) {
		Guard.Ensure(container.GetType() == typeof(ObjectContainer<>).MakeGenericType(member.DeclaringType));
	...
	internal static IClusteredStreamsAttachment CreateKeyChecksumIndexAttachment(ObjectContainer container, long streamIndex, Member member, IItemSerializer keySerializer = null, object keyChecksummer = null, object keyFetcher = null, object keyComparer = null) {
		Guard.Ensure(container.GetType() == typeof(ObjectContainer<>).MakeGenericType(member.DeclaringType));
	...
	internal static IClusteredStreamsAttachment CreateUniqueKeyChecksumIndexAttachment(ObjectContainer container, long streamIndex, Member member, IItemSerializer keySerializer = null, object keyChecksummer = null, object keyFetcher = null, object keyComparer = null) {
		Guard.Ensure(container.GetType() == typeof(ObjectContainer<>).MakeGenericType(member.DeclaringType));
