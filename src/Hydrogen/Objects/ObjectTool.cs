...
namespace Tools {
	...
	public static class Object {
		...
		public static class ProjectionMemoizer {

			private static readonly SynchronizedDictionary<object, object> _projections = new();

			public static V RememberProjection<U, V>(U item, Func<U, V> packer) {
			...
			public static V ForgetProjection<U, V>(U item) {
				using (_projections.EnterWriteScope()) {
