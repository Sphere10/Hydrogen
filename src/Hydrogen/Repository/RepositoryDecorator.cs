...
public class RepositoryDecorator<TEntity, TIdentity, TConcrete> : IRepository<TEntity, TIdentity> where TConcrete : IRepository<TEntity, TIdentity> {
	...
	public event EventHandlerEx<TEntity> Changing { add => InternalCollection.Changing += value; remove => InternalCollection.Changing -= value; }
	public event EventHandlerEx<TEntity> Changed { add => InternalCollection.Changed += value; remove => InternalCollection.Changed -= value; }
	public event EventHandlerEx<TEntity> Saving { add => InternalCollection.Saving += value; remove => InternalCollection.Saving -= value; }
	public event EventHandlerEx<TEntity> Saved { add => InternalCollection.Saved += value; remove => InternalCollection.Saved -= value; }
	public event EventHandlerEx Clearing { add => InternalCollection.Clearing += value; remove => InternalCollection.Clearing -= value; }
	public event EventHandlerEx Cleared { add => InternalCollection.Cleared += value; remove => InternalCollection.Cleared -= value; }
	public event EventHandlerEx<TEntity> Adding { add => InternalCollection.Adding += value; remove => InternalCollection.Adding -= value; }
	public event EventHandlerEx<TEntity> Added { add => InternalCollection.Added += value; remove => InternalCollection.Added -= value; }
	public event EventHandlerEx<TEntity> Updating { add => InternalCollection.Updating += value; remove => InternalCollection.Updating -= value; }
	public event EventHandlerEx<TEntity> Updated { add => InternalCollection.Updated += value; remove => InternalCollection.Updated -= value; }
