//-----------------------------------------------------------------------
// <copyright file="DateTimeTool.cs" company="Sphere 10 Software">
//
...
namespace Tools {
	...
	public static class Time {
		    ...
		    public static DateTime CalculateNextDayOfWeek(DateTime fromDate, DayOfWeek dayOfWeek) {
		        ...
		        return destDayOfWeek > startDayOfWeek ? 
                    fromDate.AddDays(destDayOfWeek - startDayOfWeek).ToMidnight() : 
                    fromDate.AddDays((7 + destDayOfWeek) - startDayOfWeek).ToMidnight();;
