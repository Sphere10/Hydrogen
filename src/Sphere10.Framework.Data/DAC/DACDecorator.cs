//-----------------------------------------------------------------------
// <copyright file="DACDecorator.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Data {
	...
	public abstract class DACDecorator : IDAC {
		...
		public virtual ArtificialKeys ArtificialKeys { get { return DecoratedDAC.ArtificialKeys; } set { DecoratedDAC.ArtificialKeys = value; } }

		public virtual ILogger Log {
			get {
				return DecoratedDAC.Log;
			}
			set {
				DecoratedDAC.Log = value;
			}
		}
