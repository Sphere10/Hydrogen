//-----------------------------------------------------------------------
// <copyright file="FirebirdConnectionBar.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Windows.Forms.Firebird {
	public partial class FirebirdConnectionBar : ConnectionBarBase {
		public FirebirdConnectionBar() {
			InitializeComponent();
		}
		...
		public string Server {
			...
			set {
				_serverTextBox.Text = value;
			}
		}

		public string Database {
			get {
				return _databaseTextBox.Text;
			}
			set {
				_databaseTextBox.Text = value;
			}
		}
		...
		public string Port {
			get {
				return _portTextBox.Text;
			}
			set {
				_portTextBox.Text = value;
			}
		}
