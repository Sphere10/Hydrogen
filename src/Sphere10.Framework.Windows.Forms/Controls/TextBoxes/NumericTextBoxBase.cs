//-----------------------------------------------------------------------
// <copyright file="NumericTextBoxBase.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.Framework.Windows.Forms {
	...
	public abstract class NumericBoxBase<T> : TextBoxEx where T : struct {
		...
		public event EventHandler ValueChanged {
			add {
				this.Events.AddHandler(EVENT_VALUECHANGED, value);
			}
			remove {
				this.Events.RemoveHandler(EVENT_VALUECHANGED, value);
			}
		}
