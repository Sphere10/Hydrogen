//-----------------------------------------------------------------------
// <copyright file="WindowsMouseHook.cs" company="Sphere 10 Software">
//
                    ...
                    if (nCode >= 0) {
                        ...
                        if ((mouseMessages & WinAPI.USER32.WM.MOUSEWHEEL) == WinAPI.USER32.WM.MOUSEWHEEL) {
                            ...
                            if ((mouseMessages & WinAPI.USER32.WM.XBUTTONDOWN) == WinAPI.USER32.WM.XBUTTONDOWN) {
                                buttonClicked = (Tools.WinTool.HIWORD(mouseHookStruct.mouseData) & (ushort)WinAPI.USER32.MouseEventDataXButtons.XBUTTON1) == (ushort)WinAPI.USER32.MouseEventDataXButtons.XBUTTON1 ? MouseButton.XButton1 : MouseButton.XButton2;
                                buttonState = MouseButtonState.Down;
                            ...
                            if ((mouseMessages & WinAPI.USER32.WM.XBUTTONUP) == WinAPI.USER32.WM.XBUTTONUP) {
                                buttonClicked = (Tools.WinTool.HIWORD(mouseHookStruct.mouseData) & (ushort)WinAPI.USER32.MouseEventDataXButtons.XBUTTON2) == (ushort)WinAPI.USER32.MouseEventDataXButtons.XBUTTON2 ? MouseButton.XButton1 : MouseButton.XButton2;
                                buttonState = MouseButtonState.Up;
                                clickType = (mouseMessages & WinAPI.USER32.WM.XBUTTONDBLCLK) == WinAPI.USER32.WM.XBUTTONDBLCLK ? MouseClickType.Double : MouseClickType.Single;
                            }
