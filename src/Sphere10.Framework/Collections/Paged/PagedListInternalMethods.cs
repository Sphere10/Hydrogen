...
namespace Sphere10.Framework
{
    ...
    {
        public PagedListInternalMethods(
            Action updateVersion, Action checkRequiresLoad, Action<int, int> checkRange,
            ...
            Action<IPage<TItem>> notifyPageReading, Action<IPage<TItem>> notifyPageRead, Action<IPage<TItem>> notifyPageWriting, Action<IPage<TItem>> notifyPageWrite)
        {
