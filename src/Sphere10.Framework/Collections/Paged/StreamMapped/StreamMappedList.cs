...
namespace Sphere10.Framework {
	...
	///  - indexing
	/// </remarks>
	public class StreamMappedList<TItem> : PagedListBase<TItem, StreamPage<TItem>> {
		...
		protected override void OnPageDeleted(StreamPage<TItem> page) {
			base.OnPageDeleted(page);
			Stream.SetLength(page.Number > 0 ? page.StartPosition : 0L);
		}

		protected override StreamPage<TItem> NewPageInstance(int pageNumber) => pageNumber == 0 ? new StreamPage<TItem>(this) : new StreamPage<TItem>(_pages.Last());
