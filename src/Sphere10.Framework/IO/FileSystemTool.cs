...
namespace Tools {
    ...
    public static class FileSystem {
		...
		public static string ResolvePathTemplate(string pathTemplate, Func<string, string> tokenResolver) {
			return Text.FormatEx(pathTemplate, (token) => tokenResolver(token) ?? DefaultPathTokenResolver(token));
		}
        ...
        public static Task CopyDirectoryAsync(string sourceDir, string destDirectory, bool copySubDirectories = false, bool createIfDoesNotExist = true, bool clearIfNotEmpty = false) {
        ...
        public static void DeleteDirectory(string directory, bool ignoreIfLocked = false) {
            Action<string> deleteDirAction = ignoreIfLocked ? Lambda.ActionIgnoringExceptions<string>(Directory.Delete) : Directory.Delete;
        ...
        public static void DeleteAllFiles(string directory, bool deleteSubDirectories = true, bool ignoreIfLocked = false) {
            Action<string> deleteFileAction = ignoreIfLocked ? Lambda.ActionIgnoringExceptions<string>(File.Delete) : File.Delete;
            Action<string> deleteDirAction = ignoreIfLocked ? Lambda.ActionIgnoringExceptions<string>(Directory.Delete) : Directory.Delete;
