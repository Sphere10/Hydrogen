//-----------------------------------------------------------------------
// <copyright file="MimeTool.cs" company="Sphere 10 Software">
//
	...
	public static class Mime {
			...
			public static string MimeType(string strFileName) {
				...
				switch (Path.GetExtension(strFileName).ToLower()) {
                    ...
                    case ".ipa": retval = "application/octet-stream ipa"; break;
					...
					case ".pdb": retval = "application/octet-stream"; break;
                    ...
                    case ".plist": retval = "text/xml plist"; break;
