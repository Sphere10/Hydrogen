...
namespace Sphere10.Framework {
	/// <summary>
	/// A stream container which interlaces components streams together over a single logical stream using a clustering approach similar to how physical disk drives store data. This
	...
	/// [Listings]
	///   0: [BlobListing] Size: 60, Start Cluster: 3
	///   1: [BlobListing] Size: 88, Start Cluster: 7
	///   2: [BlobListing] Size: 27, Start Cluster: 2
	///   3: [BlobListing] Size: 43, Start Cluster: 1
	///   4: [BlobListing] Size: 0, Start Cluster: -1
	/// [Clusters]
	...
	/// </remarks>
	public class ClusteredStreamContainer : ClusteredStreamContainerT<ClusteredStreamContainerHeader, ClusteredStreamListing>, IStreamContainer {

		public ClusteredStreamContainer(Stream rootStream, int clusterSize, Endianness endianness = Endianness.LittleEndian) 
			: base(rootStream, clusterSize, new ClusteredStreamListingSerializer(), endianness) {
		}
