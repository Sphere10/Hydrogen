//-----------------------------------------------------------------------
// <copyright file="TypeResolver.cs" company="Sphere 10 Software">
//
		...
		public class AssemblyInfo {
	        ...
	        private void Load() {
		        try {
					...
					throw new SoftwareException(
						rte, 
						"Unable to assembly '{1}' due to the following errors:{0}{2}", Environment.NewLine, Assembly.FullName, rte.LoaderExceptions.Select(x => x.ToDiagnosticString()).ToDelimittedString(Environment.NewLine, "(null)"));
		        }
	        }
        }
    }
