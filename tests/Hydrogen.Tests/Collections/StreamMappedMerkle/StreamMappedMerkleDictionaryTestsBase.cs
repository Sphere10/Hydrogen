		...
		using (CreateDictionary(chf, out var clusteredDictionary)) {
			AssertEx.DictionaryIntegrationTest(
				...
				endOfIterTest: () => {
					...
					var itemHashes = Enumerable.Range(0, (int)(clusteredDictionary.ObjectContainer.StreamContainer.Count - clusteredDictionary.ObjectContainer.StreamContainer.Header.ReservedStreams)).Select(i => {
