...
public class TransactionalDictionaryTests : StreamPersistedCollectionTestsBase {
	...
	protected IDisposable Create<TKey, TValue>(IItemSerializer<TKey> keySerializer, IItemSerializer<TValue> valueSerializer, IEqualityComparer<TKey> keyComparer, IEqualityComparer<TValue> valueComparer, ClusteredStoragePolicy policy,
	                                           out TransactionalDictionary<TKey, TValue> clustered, out string file) {
