//-----------------------------------------------------------------------
// <copyright file="AppointmentBookForm.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.FrameworkTester.WinForms {
	public partial class AppointmentBookScreen : ApplicationScreen {
		...
		private void _appointmentBook_AppointmentDrop(AppointmentDropEvent arg) {
			_outputWriter.WriteLine("{0}: appointment dropped - column '{1}' appointment '{2}' target column:'{3}' start time: '{4}' end time: '{5}'", arg.Source.Name, arg.SourceColumn.Name, arg.Appointment.Subject, arg.TargetColumn.Name, arg.StartTime.ToShortTimeString(), arg.EndTime.ToShortTimeString());
		}

		private void _appointmentBook_AppointmentDropStarting(AppointmentDropStartingEvent arg) {
			_outputWriter.WriteLine("{0}: appointment drop starting - column '{1}' appointment '{2}' target column:'{3}' start time: '{4}' end time: '{5}'", arg.Source.Name, arg.SourceColumn.Name, arg.Appointment.Subject, arg.TargetColumn.Name, arg.StartTime.ToShortTimeString(), arg.EndTime.ToShortTimeString());
			// note you can cancel the drag here by settting 
			// arg.Cancel = true;
			// arg.ErrorMessage = reason for cancel
		}
		...
		private void _appointmentBook_AppointmentResizing(AppointmentResizingEvent arg) {
			_outputWriter.WriteLine("{0}: appointment resizing - column '{1}' appointment '{2}' start time: '{3}' end time: '{4}'", arg.Source.Name, arg.SourceColumn.Name, arg.Appointment.Subject, arg.SelectedStartTime.ToShortTimeString(), arg.SelectedEndTime.ToShortTimeString());
		}

		private void _appointmentBook_AppointmentResizingFinished(AppointmentResizingFinishedEvent arg) {
			_outputWriter.WriteLine("{0}: appointment resized - column '{1}' appointment '{2}' start time: '{3}' end time: '{4}'", arg.Source.Name, arg.SourceColumn.Name, arg.Appointment.Subject, arg.SelectedStartTime.ToShortTimeString(), arg.SelectedEndTime.ToShortTimeString());
		}
