...
namespace Sphere10.Framework.Tests {
	...
	public class PreAllocatedListTests {
		...
		public void AddRange() {
			var list = new PreAllocatedList<int>(10);
		...
		public void Insert_Basic() {
			...
			var list = new PreAllocatedList<int>(store, 0, PreAllocationPolicy.Fixed, 3);
		...
		public void InsertAtIndex() {
			...
			PreAllocatedList<int> preallocatedList = new PreAllocatedList<int>(list, 0, PreAllocationPolicy.Fixed, 10);
		...
		public void IntegrationTests_Fixed([Values(1, 793, 2000)] int maxCapacity) {
			...
			var list = new PreAllocatedList<int>(fixedStore, 0, PreAllocationPolicy.Fixed, maxCapacity);
		...
		public void IntegrationTests_ByBlock([Values(0, 1, 793, 2000)] int maxCapacity) {
			var list = new PreAllocatedList<int>(PreAllocationPolicy.ByBlock, 5);
			AssertEx.ListIntegrationTest(list, maxCapacity, (rng, i) => rng.NextInts(i));
		}

		[Test]
		public void IntegrationTests_MinimumRequired([Values(0, 1, 793, 2000)] int maxCapacity) {
			var list = new PreAllocatedList<int>(PreAllocationPolicy.MinimumRequired, 0);
			AssertEx.ListIntegrationTest(list, maxCapacity, (rng, i) => rng.NextInts(i));
		}
