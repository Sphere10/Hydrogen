...
namespace Sphere10.Framework.Tests
{
    ...
    public class PreAllocatedListTests {
        ...
        public void AddRange() {
            ...
            PreAllocatedList<int> preallocatedList = new PreAllocatedList<int>(list, 0);
        ...
        public void Insert_Basic() {
            ...
            var list = new PreAllocatedList<int>(store, 0);
        ...
        public void IntegrationTests([Values(0, 1, 793, 2000)] int maxCapacity) {
            ...
            var list = new PreAllocatedList<int>(fixedStore, 0);
