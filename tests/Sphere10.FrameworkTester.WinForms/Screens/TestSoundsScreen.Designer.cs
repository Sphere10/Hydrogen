...
namespace Sphere10.FrameworkTester.WinForms {
	partial class TestSoundsScreen {
		...
		private void InitializeComponent() {
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(174, 81);
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(255, 81);
			...
			this.Name = "TestSoundsScreen";
			this.Text = "TestSoundsForm";
