//-----------------------------------------------------------------------
// <copyright file="DesignerForm.cs" company="Sphere 10 Software">
//
...
namespace Sphere10.ExplorerBarDesigner {
    ...
    public class ExplorerBarSettings {
        ...
        [Category("Task Pane")]
        public Color TaskPaneGradientStart { get; set; }
        [Category("Task Pane")]
        public Color TaskPaneGradientEnd { get; set; }
        [Category("Task Pane")]
        public LinearGradientMode TaskPanelGradientDirection { get; set; }
        [Category("Task Pane")]
        public PaddingEx TaskPanePadding { get; set; }
        [Category("Task Pane")]
        public ImageStretchMode TaskPaneStretchMode { get; set; }
        [Category("Task Pane")]
        public Image TaskPaneWaterMark { get; set; }
        [Category("Task Pane")]
        public ContentAlignment TaskPaneWaterMarkContentAlignment { get; set; }

        [Category("Task Item")]
        public PaddingEx TaskItemPadding { get; set; }
        [Category("Task Item")]
        public Margin TaskItemMargin { get; set; }
        [Category("Task Item")]
        public Color TaskItemLinkNormalColor { get; set; }
        [Category("Task Item")]
        public Color TaskItemLinkHotColor { get; set; }
        [Category("Task Item")]
        public FontStyle TaskItemFontDecoration { get; set; }


        [Category("Task Expando")]
        public Color ExpandoNormalBackColor { get; set; }
        [Category("Task Expando")]
        public Border ExpandoNormalBorder { get; set; }
        [Category("Task Expando")]
        public Color ExpandoNormalBorderColor { get; set; }
        [Category("Task Expando")]
        public PaddingEx ExpandoNormalPadding { get; set; }
        [Category("Task Expando")]
        public Image ExpandoNormalBackImage { get; set; }
        [Category("Task Expando")]
        public Color ExpandoSpecialBackColor { get; set; }
        [Category("Task Expando")]
        public Border ExpandoSpecialBorder { get; set; }
        [Category("Task Expando")]
        public Color ExpandoSpecialBorderColor { get; set; }
        [Category("Task Expando")]
        public PaddingEx ExpandoSpecialPadding { get; set; }
        [Category("Task Expando")]
        public Image ExpandoSpecialBackImage { get; set; }
        [Category("Task Expando")]
        public ContentAlignment ExpandoWatermarkAlignment { get; set; }

        [Category("Header Info")]
        public Font HeaderInfoFont { get; set; }
        [Category("Header Info")]
        public int HeaderInfoMargin { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoSpecialBackImage { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoNormalBackImage { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoSpecialTitleColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoNormalTitleColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoSpecialTitleHotColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoNormalTitleHotColor { get; set; }
        [Category("Header Info")]
        public ContentAlignment HeaderInfoSpecialAlignment { get; set; }
        [Category("Header Info")]
        public ContentAlignment HeaderInfoNormalAlignment { get; set; }
        [Category("Header Info")]
        public PaddingEx HeaderInfoSpecialPadding { get; set; }
        [Category("Header Info")]
        public PaddingEx HeaderInfoNormalPadding { get; set; }
        [Category("Header Info")]
        public Border HeaderInfoSpecialBorder { get; set; }
        [Category("Header Info")]
        public Border HeaderInfoNormalBorder { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoSpecialBorderColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoNormalBorderColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoSpecialBackColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoNormalBackColor { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoSpecialArrowUp { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoSpecialArrowUpHot { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoSpecialArrowDown { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoSpecialArrowDownHot { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoNormalArrowUp { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoNormalArrowUpHot { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoNormalArrowDown { get; set; }
        [Category("Header Info")]
        public Image HeaderInfoNormalArrowDownHot { get; set; }
        [Category("Header Info")]
        public bool HeaderInfoTitleGradient { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoSpecialGradientStartColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoSpecialGradientEndColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoNormalGradientStartColor { get; set; }
        [Category("Header Info")]
        public Color HeaderInfoNormalGradientEndColor { get; set; }
        [Category("Header Info")]
        public float HeaderInfoGradientOffset { get; set; }
        [Category("Header Info")]
        public int HeaderInfoTitleRadius { get; set; }
    }
