//-----------------------------------------------------------------------
// <copyright file="CrudTestForm.cs" company="Sphere 10 Software">
//
...
namespace Hydrogen.Utils.WinFormsTester {
	...
	public class TestCrudDataSource : CrudDataSourceListBase<Employee> {
		...
		public IEnumerable<Employee> AllEmployees { get { return base.List; } }
		public Employee FirstEntity { get { return List[0]; } }
